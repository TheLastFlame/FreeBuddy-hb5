...
abstract base class HuaweiFreeBuds5
    implements
        BluetoothHeadphones,
        HeadphonesModelInfo,
        LRCBattery,
        Anc,
        HeadphonesSettings<HuaweiFreeBuds5Settings> {
  const HuaweiFreeBuds5();

  @override
  String get vendor => "Huawei";

  @override
  String get name => "FreeBuds 5";
  ...
  static final idNameRegex = RegExp(
    r'^(?=(HUAWEI FreeBuds 5))',
    caseSensitive: true,
  );
}
